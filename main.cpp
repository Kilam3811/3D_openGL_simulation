...
void testing_Draw() {
	...
	rec.setColor(1, 0 , 0 );
	rec.setColorInGL();
	rec.setLength(10, 15, 15);
	rec.setPosition(20, 0, 20);
	glTranslated(10, 0, 0);
	rec.setRotation(90);
	rec.positionInGL();
	rec.draw();
	...
	cy.setColor(1, 0, 0);
	cy.setColorInGL();
	cy.set_Dimension(5, 10, 100, 100);
	cy.setPosition(0, 0, 0);
	//cy.setRotation(90);
	cy.positionInGL();
	cy.draw();
	glPopMatrix();*/
